...
public class NPC {
    ...
    /*
    Down bellow is a method that spawns villagers,
    i made it that every time they get respawned from different house they memorize that as their spawn place
    and all their stats go back to default.
     */
